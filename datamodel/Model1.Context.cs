...
namespace datamodel
{
    ...
    public partial class Entities2 : DbContext
    {
        ...
        public virtual int LendBook(Nullable<int> idBook, Nullable<int> idStudent, Nullable<System.DateTime> date)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("LendBook", idBookParameter, idStudentParameter, dateParameter);
        }
    
        public virtual int ReturnBook(Nullable<int> idBook, Nullable<System.DateTime> date)
        {
            var idBookParameter = idBook.HasValue ?
                new ObjectParameter("idBook", idBook) :
                new ObjectParameter("idBook", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ReturnBook", idBookParameter, dateParameter);
        }
    }
}
